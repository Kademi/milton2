...
public class DigestAuthenticationHandler implements AuthenticationHandler {
	...
	public DigestAuthenticationHandler(NonceProvider nonceProvider, RequestHostService requestHostService) {
		this.nonceProvider = nonceProvider;
		this.digestHelper = new DigestHelper(nonceProvider, requestHostService);
	}
	...
	public Object authenticate(Resource r, Request request) {
		...
		DigestResponse resp = digestHelper.calculateResponse(auth, realm, request.getMethod(), r);
		if (resp == null) {
