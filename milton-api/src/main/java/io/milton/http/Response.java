...
public interface Response {
    ...
    /**
     *
     * @return - the content length which might have been set by a handler, or
    ...
    /**
     * Set the cache control header to allow the resource to be cached for the
    ...
    /**
     * Set the cache control header to indicate that the resource should not be
     * cached
     */
    ...
    /**
     * Called to indicate that the request is completed. Some response
     * implementations might choose to close the http connection, while others
     * which implement pipelining might not
     */
    void close();

    /**
     * Called by milton when an error occurs. The underlying HTTP provider
     * should choose to close the HTTP connection, because the amount of data
     * already sent might not be consistent with the content length header which
    ...
    /**
     * Will set the status to moved_temporarily and set the location header to
     * the given url
     *
     * @param url
     */
    ...
    /**
     * Will set the status to moved_permanently and set the location header to
     * the given url
     *
     * @param url
     */
